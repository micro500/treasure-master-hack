...
void tm_128_8_test::process_test_case(uint8 * test_case, uint16 * rng_seed, int algorithm)
{
	...
	{
		alg1((uint8*)working_code, (uint8*)regular_rng_values_lo, (uint8*)regular_rng_values_hi, *rng_seed);
		*rng_seed = rng_seed_forward_128[*rng_seed];
	}
	else if (algorithm == 2)
	{
	...
	{
		alg1((uint8*)working_code, (uint8*)alg4_values_lo, (uint8*)alg4_values_hi, *rng_seed);
		*rng_seed = rng_seed_forward_128[*rng_seed];
	}
	else if (algorithm == 5)
	{
