...
tm_128_8_test::tm_128_8_test()
{
	...
	regular_rng_values = (uint8*)aligned_malloc(0x10000 * 128, 32);
	generate_regular_rng_values_8(regular_rng_values, rng_table);

	regular_rng_values_lo = (uint8*)aligned_malloc(0x10000 * 128, 32);
	generate_regular_rng_values_8_lo(regular_rng_values_lo, rng_table);

	regular_rng_values_hi = (uint8*)aligned_malloc(0x10000 * 128, 32);
	generate_regular_rng_values_8_hi(regular_rng_values_hi, rng_table);

	alg0_values = (uint8*)aligned_malloc(0x10000 * 128, 32);
	generate_alg0_values_8(alg0_values, rng_table);

	alg6_values = (uint8*)aligned_malloc(0x10000 * 128, 32);
	generate_alg6_values_8(alg6_values, rng_table);

	alg4_values_lo = (uint8*)aligned_malloc(0x10000 * 128, 32);
	generate_alg4_values_8_lo(alg4_values_lo, rng_table);

	alg4_values_hi = (uint8*)aligned_malloc(0x10000 * 128, 32);
	generate_alg4_values_8_hi(alg4_values_hi, rng_table);

	alg2_values = (uint8*)aligned_malloc(0x10000 * 16, 32);
	generate_alg2_values_128_8(alg2_values, rng_table);

	alg5_values = (uint8*)aligned_malloc(0x10000 * 16, 32);
...
void tm_128_8_test::process_test_case(uint8 * test_case, uint16 * rng_seed, int algorithm)
{
	ALIGNED(32) uint8 working_code[128];
	...
	{
		alg1((uint8*)working_code, (uint8*)regular_rng_values_lo, (uint8*)regular_rng_values_hi, &(this->rng_seed), this->rng_table, rng_seed_forward_128);
	}
	else if (algorithm == 2)
	{
		alg2((uint8*)working_code, (uint8*)alg2_values, &(this->rng_seed), this->rng_table, rng_seed_forward_1);
	}
	else if (algorithm == 3)
	{
	...
	{
		alg1((uint8*)working_code, (uint8*)alg4_values_lo, (uint8*)alg4_values_hi, &(this->rng_seed), this->rng_table, rng_seed_forward_128);
	}
	else if (algorithm == 5)
	{
		alg5((uint8*)working_code, (uint8*)alg5_values, &(this->rng_seed), this->rng_table, rng_seed_forward_1);
	}
	else if (algorithm == 6)
	{
...
void tm_128_8_test::run_iterations(uint8 * test_case, uint16 * rng_seed, int algorithm, int iterations)
{
	ALIGNED(32) uint8 working_code[128];
