...
void main()
{
	...
	generate_regular_rng_values((uint16*)regular_rng_values, &rng_seed, rng_table);

	uint8 * alg0_values = (uint8*)aligned_malloc(0x10000 * 128 * 2, 32);
	generate_alg0_values((uint16*)alg0_values, &rng_seed, rng_table);

	uint8 * alg6_values = (uint8*)aligned_malloc(0x10000 * 128 * 2, 32);
	generate_alg6_values((uint16*)alg6_values, &rng_seed, rng_table);

	uint8 *alg2_values = (uint8*)aligned_malloc(0x10000 * 32, 32);
	generate_alg2_values(alg2_values, &rng_seed, rng_table);

	uint8 *alg5_values = (uint8*)aligned_malloc(0x10000 * 32, 32);
	generate_alg5_values(alg5_values, &rng_seed, rng_table);
	...
	generate_seed_forward_128(rng_forward_128, &rng_seed, rng_table);
