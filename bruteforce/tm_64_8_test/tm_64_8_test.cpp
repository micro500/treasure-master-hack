...
tm_64_8_test::tm_64_8_test()
{
	...
	generate_alg2_values_64_8(alg2_values_64, rng_table);

	alg5_values_64 = new uint64[0x10000 * 128];
	generate_alg5_values_64_8(alg5_values_64, rng_table);
...
void tm_64_8_test::process_test_case(uint8 * test_case, uint16 * rng_seed, int algorithm)
{
	...
	{
		alg1((uint64*)working_code, (uint64*)regular_rng_values_lo, (uint64*)regular_rng_values_hi, &(this->rng_seed), this->rng_table, rng_seed_forward_128);
	}
	else if (algorithm == 2)
	{
	...
	{
		alg1((uint64*)working_code, (uint64*)alg4_values_lo, (uint64*)alg4_values_hi, &(this->rng_seed), this->rng_table, rng_seed_forward_128);
	}
	else if (algorithm == 5)
	{
