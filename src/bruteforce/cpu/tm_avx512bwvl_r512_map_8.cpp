...
void tm_avx512bwvl_r512_map_8::test_algorithm(int algorithm_id, uint8_t* data, uint16_t* rng_seed)
{
...
void tm_avx512bwvl_r512_map_8::test_algorithm_n(int algorithm_id, uint8_t* data, uint16_t* rng_seed, int iterations)
{
	...
	uint8_t* reg_base = regular_rng_values_for_seeds_8;
	uint8_t* alg0_base = alg0_values_for_seeds_8;
	uint8_t* alg6_base = alg6_values_for_seeds_8;
	uint16_t local_pos = 2047;
...
bool tm_avx512bwvl_r512_map_8::initialized = false;
