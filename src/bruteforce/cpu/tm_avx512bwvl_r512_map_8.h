#ifndef TM_AVX512BWVL_R512_MAP_8_H
#define TM_AVX512BWVL_R512_MAP_8_H
#include <optional>
#include "simd.h"
...
class tm_avx512bwvl_r512_map_8 : public TM_base
{
public:
	tm_avx512bwvl_r512_map_8(RNG* rng);
	tm_avx512bwvl_r512_map_8(RNG* rng, uint32_t key);
	tm_avx512bwvl_r512_map_8(RNG* rng, const uint32_t key, const key_schedule& schedule_entries);
...
#endif // TM_AVX512BWVL_R512_MAP_8_H
