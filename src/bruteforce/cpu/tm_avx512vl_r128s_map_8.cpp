...
tm_avx512vl_r128s_map_8::tm_avx512vl_r128s_map_8(RNG* rng_obj) : tm_avx512vl_r128s_map_8(rng_obj, 0) {}

tm_avx512vl_r128s_map_8::tm_avx512vl_r128s_map_8(RNG* rng_obj, const uint32_t key) : tm_avx512vl_r128s_map_8(rng_obj, key, key_schedule(key, key_schedule::ALL_MAPS)) {}

tm_avx512vl_r128s_map_8::tm_avx512vl_r128s_map_8(RNG* rng_obj, const uint32_t key, const key_schedule& schedule_entries)
	: TM_base(rng_obj),
	  ...
	  sel_even(_mm_set_epi8(static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), 14, 12, 10, 8, 6, 4, 2, 0)),
	  sel_odd(_mm_set_epi8(static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), static_cast<int8_t>(0x80), 15, 13, 11, 9, 7, 5, 3, 1))
{
	initialize();
	this->key = key;
...
tm_avx512vl_r128s_map_8::~tm_avx512vl_r128s_map_8()
{
}

__forceinline void tm_avx512vl_r128s_map_8::initialize()
{
	if (!_initialized)
	{
		_initialized = true;
	}
	obj_name = "tm_avx512vl_r128s_map_8";
}

void tm_avx512vl_r128s_map_8::generate_map_rng()
{
...
__forceinline void tm_avx512vl_r128s_map_8::_load_fwd(const uint8_t* block_start, WC_ARGS_128)
{
	__m128i a, b;
...
__forceinline void tm_avx512vl_r128s_map_8::_load_rev(const uint8_t* block_start, WC_ARGS_128)
{
	__m128i a, b;
...
__forceinline void tm_avx512vl_r128s_map_8::_load_from_mem(WC_ARGS_128)
{
...
__forceinline void tm_avx512vl_r128s_map_8::_store_to_mem(WC_ARGS_128)
{
...
__forceinline void tm_avx512vl_r128s_map_8::_expand_code(uint32_t data, WC_ARGS_128)
{
	...
	uint8_t* rng_start = expansion_values_for_seed_128_8_shuffled.get();
...
void tm_avx512vl_r128s_map_8::load_data(uint8_t* new_data)
{
	for (int i = 0; i < 128; i++)
		working_code_data[shuffle_8(i, 128)] = new_data[i];
}

void tm_avx512vl_r128s_map_8::fetch_data(uint8_t* new_data)
{
	for (int i = 0; i < 128; i++)
		new_data[i] = working_code_data[shuffle_8(i, 128)];
}

__forceinline void tm_avx512vl_r128s_map_8::alg_2_sub(__m128i& working_a, __m128i& working_b, __m128i& carry)
{
	__m128i cur_val1_srl = _mm_srli_si128(working_a, 1);
	__m128i next_carry = _mm_and_si128(_mm_slli_si128(working_a, 15), mask_top_01);

	working_a = _mm_ternarylogic_epi32(_mm_srli_epi16(working_a, 1), working_b, mask_80, 0xD8);
	working_b = _mm_or_si128(
		_mm_ternarylogic_epi32(_mm_slli_epi16(working_b, 1), cur_val1_srl, mask_FE, 0xE4),
		carry);

	carry = next_carry;
}

__forceinline void tm_avx512vl_r128s_map_8::alg_5_sub(__m128i& working_a, __m128i& working_b, __m128i& carry)
{
	__m128i cur_val1_srl = _mm_srli_si128(working_a, 1);
	__m128i next_carry = _mm_and_si128(_mm_slli_si128(working_a, 15), mask_top_80);

	working_a = _mm_ternarylogic_epi32(_mm_slli_epi16(working_a, 1), working_b, mask_01, 0xD8);
	working_b = _mm_or_si128(
		_mm_ternarylogic_epi32(_mm_srli_epi16(working_b, 1), cur_val1_srl, mask_7F, 0xE4),
		carry);

	carry = next_carry;
}

__forceinline void tm_avx512vl_r128s_map_8::alg_0(WC_ARGS_128, const uint8_t* block_start)
{
	__m128i r0, r1, r2, r3, r4, r5, r6, r7;
	_load_fwd(block_start, r0, r1, r2, r3, r4, r5, r6, r7);
	wc0 = _mm_ternarylogic_epi32(_mm_slli_epi16(wc0, 1), mask_FE, r0, 0xEA);
	wc1 = _mm_ternarylogic_epi32(_mm_slli_epi16(wc1, 1), mask_FE, r1, 0xEA);
	wc2 = _mm_ternarylogic_epi32(_mm_slli_epi16(wc2, 1), mask_FE, r2, 0xEA);
	wc3 = _mm_ternarylogic_epi32(_mm_slli_epi16(wc3, 1), mask_FE, r3, 0xEA);
	wc4 = _mm_ternarylogic_epi32(_mm_slli_epi16(wc4, 1), mask_FE, r4, 0xEA);
	wc5 = _mm_ternarylogic_epi32(_mm_slli_epi16(wc5, 1), mask_FE, r5, 0xEA);
	wc6 = _mm_ternarylogic_epi32(_mm_slli_epi16(wc6, 1), mask_FE, r6, 0xEA);
	wc7 = _mm_ternarylogic_epi32(_mm_slli_epi16(wc7, 1), mask_FE, r7, 0xEA);
}

__forceinline void tm_avx512vl_r128s_map_8::alg_1(WC_ARGS_128, const uint8_t* block_start)
{
	__m128i r0, r1, r2, r3, r4, r5, r6, r7;
	_load_fwd(block_start, r0, r1, r2, r3, r4, r5, r6, r7);
...
__forceinline void tm_avx512vl_r128s_map_8::alg_2(WC_ARGS_128, uint8_t carry_byte)
{
...
__forceinline void tm_avx512vl_r128s_map_8::alg_3(WC_ARGS_128, const uint8_t* block_start)
{
	__m128i r0, r1, r2, r3, r4, r5, r6, r7;
	_load_fwd(block_start, r0, r1, r2, r3, r4, r5, r6, r7);
...
__forceinline void tm_avx512vl_r128s_map_8::alg_4(WC_ARGS_128, const uint8_t* block_start)
{
	__m128i r0, r1, r2, r3, r4, r5, r6, r7;
	_load_fwd(block_start, r0, r1, r2, r3, r4, r5, r6, r7);
...
__forceinline void tm_avx512vl_r128s_map_8::alg_5(WC_ARGS_128, uint8_t carry_byte)
{
...
__forceinline void tm_avx512vl_r128s_map_8::alg_6(WC_ARGS_128, const uint8_t* block_start)
{
	__m128i r0, r1, r2, r3, r4, r5, r6, r7;
	_load_fwd(block_start, r0, r1, r2, r3, r4, r5, r6, r7);
	wc0 = _mm_ternarylogic_epi32(_mm_srli_epi16(wc0, 1), mask_7F, r0, 0xEA);
	wc1 = _mm_ternarylogic_epi32(_mm_srli_epi16(wc1, 1), mask_7F, r1, 0xEA);
	wc2 = _mm_ternarylogic_epi32(_mm_srli_epi16(wc2, 1), mask_7F, r2, 0xEA);
	wc3 = _mm_ternarylogic_epi32(_mm_srli_epi16(wc3, 1), mask_7F, r3, 0xEA);
	wc4 = _mm_ternarylogic_epi32(_mm_srli_epi16(wc4, 1), mask_7F, r4, 0xEA);
	wc5 = _mm_ternarylogic_epi32(_mm_srli_epi16(wc5, 1), mask_7F, r5, 0xEA);
	wc6 = _mm_ternarylogic_epi32(_mm_srli_epi16(wc6, 1), mask_7F, r6, 0xEA);
	wc7 = _mm_ternarylogic_epi32(_mm_srli_epi16(wc7, 1), mask_7F, r7, 0xEA);
}

__forceinline void tm_avx512vl_r128s_map_8::alg_7(WC_ARGS_128)
{
...
__forceinline void tm_avx512vl_r128s_map_8::add_alg_shuffled(WC_ARGS_128, uint16_t* rng_seed, uint8_t* rng_start)
{
...
__forceinline void tm_avx512vl_r128s_map_8::xor_alg(WC_ARGS_128, uint8_t* values)
{
...
__forceinline void tm_avx512vl_r128s_map_8::_run_alg(WC_ARGS_128, int algorithm_id, uint16_t* local_pos, const uint8_t* reg_base, const uint8_t* alg0_base, const uint8_t* alg6_base)
{
	if (algorithm_id == 0)
	{
...
__forceinline void tm_avx512vl_r128s_map_8::_run_one_map(WC_ARGS_128, int map_idx)
{
	...
	for (int i = 0; i < 16; i++)
	{
		...
		unsigned char nibble = static_cast<unsigned char>((nibble_selector >> 15) & 0x01);
		nibble_selector <<= 1;

		unsigned char current_byte = working_code_data[shuffle_8(i, 128)];
		if (nibble == 1)
			current_byte >>= 4;
		unsigned char algorithm_id = static_cast<unsigned char>((current_byte >> 1) & 0x07);

		_run_alg(WC_PASS_128, algorithm_id, &local_pos, reg_base, alg0_base, alg6_base);
	}
}

__forceinline void tm_avx512vl_r128s_map_8::_run_all_maps(WC_ARGS_128)
{
...
void tm_avx512vl_r128s_map_8::_decrypt_carnival_world(WC_ARGS_128)
{
	xor_alg(WC_PASS_128, carnival_world_data_shuffled);
}

void tm_avx512vl_r128s_map_8::_decrypt_other_world(WC_ARGS_128)
{
	xor_alg(WC_PASS_128, other_world_data_shuffled);
}

__forceinline void tm_avx512vl_r128s_map_8::mid_sum(
...
__forceinline uint16_t tm_avx512vl_r128s_map_8::masked_checksum(WC_ARGS_128, uint8_t* mask)
{
...
__forceinline uint16_t tm_avx512vl_r128s_map_8::_calculate_carnival_world_checksum(WC_ARGS_128)
{
	return masked_checksum(WC_PASS_128, carnival_world_checksum_mask_shuffled);
}

__forceinline uint16_t tm_avx512vl_r128s_map_8::_calculate_other_world_checksum(WC_ARGS_128)
{
	return masked_checksum(WC_PASS_128, other_world_checksum_mask_shuffled);
}

__forceinline uint16_t tm_avx512vl_r128s_map_8::fetch_checksum_value(WC_ARGS_128, uint8_t code_length)
{
	_store_to_mem(WC_PASS_128);
	uint8_t lo = working_code_data[shuffle_8(127 - code_length, 128)];
	uint8_t hi = working_code_data[shuffle_8(127 - (code_length + 1), 128)];
	return static_cast<uint16_t>((hi << 8) | lo);
}

__forceinline uint16_t tm_avx512vl_r128s_map_8::_fetch_carnival_world_checksum_value(WC_ARGS_128)
{
	return fetch_checksum_value(WC_PASS_128, CARNIVAL_WORLD_CODE_LENGTH - 2);
}

__forceinline uint16_t tm_avx512vl_r128s_map_8::_fetch_other_world_checksum_value(WC_ARGS_128)
{
	return fetch_checksum_value(WC_PASS_128, OTHER_WORLD_CODE_LENGTH - 2);
}

__forceinline bool tm_avx512vl_r128s_map_8::check_carnival_world_checksum(WC_ARGS_128)
{
	return _calculate_carnival_world_checksum(WC_PASS_128)
	    == _fetch_carnival_world_checksum_value(WC_PASS_128);
}

__forceinline bool tm_avx512vl_r128s_map_8::check_other_world_checksum(WC_ARGS_128)
{
...
std::optional<uint8_t> tm_avx512vl_r128s_map_8::_decrypt_check(WC_ARGS_128)
{
	WC_XOR_VARS_128;
	WC_COPY_XOR_128;
...
__forceinline void tm_avx512vl_r128s_map_8::_run_bruteforce(WC_ARGS_128, uint32_t data, uint8_t* result_data, uint32_t* result_size)
{
...
void tm_avx512vl_r128s_map_8::run_bruteforce_boinc(uint32_t start_data, uint32_t amount_to_run, void(*report_progress)(double), uint8_t* result_data, uint32_t result_max_size, uint32_t* result_size)
{
	WC_VARS_128;
...
void tm_avx512vl_r128s_map_8::compute_challenge_flags(uint32_t data, uint8_t& carnival_flags_out, uint8_t& other_flags_out)
{
	WC_VARS_128;
...
void tm_avx512vl_r128s_map_8::test_algorithm_chain(const uint8_t* algorithm_ids, int chain_length,
...
void tm_avx512vl_r128s_map_8::test_algorithm_n(int algorithm_id, uint8_t* data, uint16_t* rng_seed, int iterations)
{
	WC_VARS_128;
	load_data(data);
	_load_from_mem(WC_PASS_128);
...
void tm_avx512vl_r128s_map_8::test_expansion(uint32_t data, uint8_t* result_out)
{
	WC_VARS_128;
	_expand_code(data, WC_PASS_128);
	_store_to_mem(WC_PASS_128);
	unshuffle_mem(working_code_data, result_out, 128, false);
}

void tm_avx512vl_r128s_map_8::test_bruteforce_data(uint32_t data, uint8_t* result_out)
{
	WC_VARS_128;
	_expand_code(data, WC_PASS_128);
	_run_all_maps(WC_PASS_128);
...
bool tm_avx512vl_r128s_map_8::test_bruteforce_checksum(uint32_t data, int world)
{
	WC_VARS_128;
	_expand_code(data, WC_PASS_128);
	_run_all_maps(WC_PASS_128);
...
void tm_avx512vl_r128s_map_8::set_key(uint32_t new_key)
{
