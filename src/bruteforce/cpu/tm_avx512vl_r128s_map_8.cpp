...
__forceinline void tm_avx512vl_r128s_map_8::_expand_code(uint32_t data, WC_ARGS_128)
{
	...
	uint8_t* rng_start = expansion_values_for_seed_128_8_shuffled;
...
void tm_avx512vl_r128s_map_8::test_algorithm(int algorithm_id, uint8_t* data, uint16_t* rng_seed)
{
...
bool tm_avx512vl_r128s_map_8::initialized = false;
