#ifndef TM_SSSE3_M128S_MAP_8_H
#define TM_SSSE3_M128S_MAP_8_H
#include <optional>
#include "simd.h"
...
class tm_ssse3_m128s_map_8 : public TM_base
{
public:
	tm_ssse3_m128s_map_8(RNG* rng);
	tm_ssse3_m128s_map_8(RNG* rng, uint32_t key);
	tm_ssse3_m128s_map_8(RNG* rng, const uint32_t key, const key_schedule& schedule_entries);
...
private:
	...
	void xor_alg(WC_ARGS_128, const uint8_t* values);
	...
	void _run_alg(WC_ARGS_128, int algorithm_id, uint16_t* local_pos, const uint8_t* reg_base, const uint8_t* alg0_base, const uint8_t* alg6_base);
	...
	alignas(16) const __m128i sel_even;
	alignas(16) const __m128i sel_odd;
