#ifndef TM_AVX_M256_8_H
#define TM_AVX_M256_8_H
#include <optional>
#include "simd.h"
...
class tm_avx_m256_8 : public TM_base
{
public:
	tm_avx_m256_8(RNG* rng);
	tm_avx_m256_8(RNG* rng, uint32_t key);
	tm_avx_m256_8(RNG* rng, const uint32_t key, const key_schedule& schedule_entries);
...
private:
	...
	uint8_t* _alg2_256_8 = nullptr;
	uint8_t* _alg4_8 = nullptr;
	uint8_t* _alg5_256_8 = nullptr;
	uint8_t* _alg6_8 = nullptr;
};
#endif // TM_AVX_M256_8_H
