#ifndef TM_AVX512BWVL_R512_8_H
#define TM_AVX512BWVL_R512_8_H
#include <optional>
#include "simd.h"
...
class tm_avx512bwvl_r512_8 : public TM_base
{
public:
	tm_avx512bwvl_r512_8(RNG* rng);
	tm_avx512bwvl_r512_8(RNG* rng, uint32_t key);
	tm_avx512bwvl_r512_8(RNG* rng, const uint32_t key, const key_schedule& schedule_entries);
...
private:
	...
	void alg_2_sub(__m512i& wc, __m512i& carry);
	void alg_5_sub(__m512i& wc, __m512i& carry);
