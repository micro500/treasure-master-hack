#ifndef TM_AVX512VL_R128_MAP_8_H
#define TM_AVX512VL_R128_MAP_8_H
#include <optional>
#include "simd.h"
...
// Like tm_avx512vl_r128_8 but uses per-schedule precomputed RNG tables instead of
// global per-seed tables. Uses vpternlogd for alg_0, alg_6, alg_2_sub, alg_5_sub.
// Natural (non-shuffled) memory layout: wc0 = bytes[0..15], ..., wc7 = bytes[112..127].
//
// Per-schedule tables (generated by generate_map_rng):
//   expansion_values_for_seed_128_8 — 128-byte expansion pattern
//   regular_rng_values_for_seeds_8  — raw RNG bytes for alg 1/3/4
//   alg0_values_for_seeds_8         — bit 7 extracted as bit 0 for alg 0
...
//   alg6_values_for_seeds_8         — bit 7 masked (& 0x80) for alg 6

class tm_avx512vl_r128_map_8 : public TM_base
{
public:
	tm_avx512vl_r128_map_8(RNG* rng);
	tm_avx512vl_r128_map_8(RNG* rng, uint32_t key);
	tm_avx512vl_r128_map_8(RNG* rng, const uint32_t key, const key_schedule& schedule_entries);
...
#endif // TM_AVX512VL_R128_MAP_8_H
