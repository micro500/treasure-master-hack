#ifndef TM_AVX2_R256_8_H
#define TM_AVX2_R256_8_H
#include <optional>
#include "simd.h"
...
// Natural (non-shuffled) AVX2 256-bit register implementation.
...
class tm_avx2_r256_8 : public TM_base
{
public:
	tm_avx2_r256_8(RNG* rng);
