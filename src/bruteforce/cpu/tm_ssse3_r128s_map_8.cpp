...
bool tm_ssse3_r128s_map_8::initialized = false;

// ---------------------------------------------------------------------------
// Test interface
// ---------------------------------------------------------------------------

void tm_ssse3_r128s_map_8::test_algorithm(int algorithm_id, uint8_t* data, uint16_t* rng_seed)
{
...
void tm_ssse3_r128s_map_8::test_algorithm_n(int algorithm_id, uint8_t* data, uint16_t* rng_seed, int iterations)
{
	...
	for (int i = 0; i < iterations; i++)
	{
		...
		_run_alg(WC_PASS_128, algorithm_id, &local_pos, regular_rng_values_for_seeds_8, alg0_values_for_seeds_8, alg6_values_for_seeds_8);
	}
