#ifndef TM_SSSE3_M128S_8_H
#define TM_SSSE3_M128S_8_H
#include <optional>
#include "simd.h"
...
class tm_ssse3_m128s_8 : public TM_base
{
public:
	tm_ssse3_m128s_8(RNG* rng);
	tm_ssse3_m128s_8(RNG* rng, uint32_t key);
	tm_ssse3_m128s_8(RNG* rng, const uint32_t key, const key_schedule& schedule_entries);
