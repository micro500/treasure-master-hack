#ifndef TM_AVX512VL_R128S_8_H
#define TM_AVX512VL_R128S_8_H
#include <optional>
#include "simd.h"
...
class tm_avx512vl_r128s_8 : public TM_base
{
public:
	tm_avx512vl_r128s_8(RNG* rng);
	tm_avx512vl_r128s_8(RNG* rng, uint32_t key);
	tm_avx512vl_r128s_8(RNG* rng, const uint32_t key, const key_schedule& schedule_entries);
...
private:
	...
	ALIGNED(16) uint8_t working_code_data[128];
