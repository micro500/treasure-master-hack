#ifndef TM_AVX_R128_MAP_8_H
#define TM_AVX_R128_MAP_8_H
#include <optional>
#include "simd.h"
...
// Like tm_avx_r128s_map_8 but uses natural (non-shuffled) memory layout:
// wc0 = bytes[0..15], wc1 = bytes[16..31], ..., wc7 = bytes[112..127].
//
...
// No global per-seed static tables needed; no unshuffle_mem in _decrypt_check.

class tm_avx_r128_map_8 : public TM_base
{
public:
	tm_avx_r128_map_8(RNG* rng);
	tm_avx_r128_map_8(RNG* rng, uint32_t key);
	tm_avx_r128_map_8(RNG* rng, const uint32_t key, const key_schedule& schedule_entries);
