...
tm_ssse3_r128_map_8::tm_ssse3_r128_map_8(RNG* rng_obj) : tm_ssse3_r128_map_8(rng_obj, 0) {}

tm_ssse3_r128_map_8::tm_ssse3_r128_map_8(RNG* rng_obj, const uint32_t key) : tm_ssse3_r128_map_8(rng_obj, key, key_schedule(key, key_schedule::ALL_MAPS)) {}

tm_ssse3_r128_map_8::tm_ssse3_r128_map_8(RNG* rng_obj, const uint32_t key, const key_schedule& schedule_entries)
	: TM_base(rng_obj),
...
tm_ssse3_r128_map_8::~tm_ssse3_r128_map_8()
{
}
...
__forceinline void tm_ssse3_r128_map_8::initialize()
{
	if (!_initialized)
	{
		_initialized = true;
	}
	obj_name = "tm_ssse3_r128_map_8";
}
...
__forceinline void tm_ssse3_r128_map_8::generate_map_rng()
{
...
__forceinline void tm_ssse3_r128_map_8::_load_from_mem(WC_ARGS_128)
{
...
__forceinline void tm_ssse3_r128_map_8::_store_to_mem(WC_ARGS_128)
{
...
__forceinline void tm_ssse3_r128_map_8::load_data(uint8_t* new_data)
{
	for (int i = 0; i < 128; i++)
		working_code_data[i] = new_data[i];
}

__forceinline void tm_ssse3_r128_map_8::fetch_data(uint8_t* new_data)
{
	for (int i = 0; i < 128; i++)
...
__forceinline void tm_ssse3_r128_map_8::_expand_code(uint32_t data, WC_ARGS_128)
{
...
// ---------------------------------------------------------------------------
// Carry-propagation helpers (natural interleaved layout)
// ---------------------------------------------------------------------------

__forceinline void tm_ssse3_r128_map_8::alg_2_sub(__m128i& wc, __m128i& carry)
{
...
__forceinline void tm_ssse3_r128_map_8::alg_5_sub(__m128i& wc, __m128i& carry)
{
	...
	__m128i new_hi = _mm_or_si128(
		_mm_and_si128(_mm_srli_epi16(wc, 1), _mm_set1_epi16(static_cast<int16_t>(0x7F00))),
		carry_in);
...
__forceinline void tm_ssse3_r128_map_8::alg_0(WC_ARGS_128, const uint8_t* block_start)
{
...
__forceinline void tm_ssse3_r128_map_8::alg_1(WC_ARGS_128, const uint8_t* block_start)
{
...
__forceinline void tm_ssse3_r128_map_8::alg_2(WC_ARGS_128, uint8_t carry_byte)
{
...
__forceinline void tm_ssse3_r128_map_8::alg_3(WC_ARGS_128, const uint8_t* block_start)
{
...
__forceinline void tm_ssse3_r128_map_8::alg_4(WC_ARGS_128, const uint8_t* block_start)
{
...
__forceinline void tm_ssse3_r128_map_8::alg_5(WC_ARGS_128, uint8_t carry_byte)
{
...
__forceinline void tm_ssse3_r128_map_8::alg_6(WC_ARGS_128, const uint8_t* block_start)
{
...
__forceinline void tm_ssse3_r128_map_8::alg_7(WC_ARGS_128)
{
...
__forceinline void tm_ssse3_r128_map_8::xor_alg(WC_ARGS_128, uint8_t* values)
{
...
__forceinline void tm_ssse3_r128_map_8::_run_alg(WC_ARGS_128, int algorithm_id, uint16_t* local_pos,
...
__forceinline void tm_ssse3_r128_map_8::_run_one_map(WC_ARGS_128, int map_idx)
{
...
__forceinline void tm_ssse3_r128_map_8::_run_all_maps(WC_ARGS_128)
{
...
__forceinline void tm_ssse3_r128_map_8::_decrypt_carnival_world(WC_ARGS_128)
{
	xor_alg(WC_PASS_128, carnival_world_data);
}

__forceinline void tm_ssse3_r128_map_8::_decrypt_other_world(WC_ARGS_128)
{
...
__forceinline void tm_ssse3_r128_map_8::mid_sum(
...
__forceinline uint16_t tm_ssse3_r128_map_8::masked_checksum(WC_ARGS_128, uint8_t* mask)
{
...
__forceinline uint16_t tm_ssse3_r128_map_8::_calculate_carnival_world_checksum(WC_ARGS_128)
{
	return masked_checksum(WC_PASS_128, carnival_world_checksum_mask);
}

__forceinline uint16_t tm_ssse3_r128_map_8::_calculate_other_world_checksum(WC_ARGS_128)
{
	return masked_checksum(WC_PASS_128, other_world_checksum_mask);
}

__forceinline uint16_t tm_ssse3_r128_map_8::fetch_checksum_value(WC_ARGS_128, uint8_t code_length)
{
...
__forceinline uint16_t tm_ssse3_r128_map_8::_fetch_carnival_world_checksum_value(WC_ARGS_128)
{
	return fetch_checksum_value(WC_PASS_128, CARNIVAL_WORLD_CODE_LENGTH - 2);
}

__forceinline uint16_t tm_ssse3_r128_map_8::_fetch_other_world_checksum_value(WC_ARGS_128)
{
	return fetch_checksum_value(WC_PASS_128, OTHER_WORLD_CODE_LENGTH - 2);
}

__forceinline bool tm_ssse3_r128_map_8::check_carnival_world_checksum(WC_ARGS_128)
{
	return _calculate_carnival_world_checksum(WC_PASS_128)
	    == _fetch_carnival_world_checksum_value(WC_PASS_128);
}

__forceinline bool tm_ssse3_r128_map_8::check_other_world_checksum(WC_ARGS_128)
{
...
__forceinline std::optional<uint8_t> tm_ssse3_r128_map_8::_decrypt_check(WC_ARGS_128)
{
	WC_XOR_VARS_128;
	WC_COPY_XOR_128;
...
__forceinline void tm_ssse3_r128_map_8::_run_bruteforce(WC_ARGS_128, uint32_t data, uint8_t* result_data, uint32_t* result_size)
{
...
void tm_ssse3_r128_map_8::run_bruteforce_boinc(uint32_t start_data, uint32_t amount_to_run, void(*report_progress)(double), uint8_t* result_data, uint32_t result_max_size, uint32_t* result_size)
{
	WC_VARS_128;
...
void tm_ssse3_r128_map_8::compute_challenge_flags(uint32_t data, uint8_t& carnival_flags_out, uint8_t& other_flags_out)
{
	WC_VARS_128;
...
void tm_ssse3_r128_map_8::test_algorithm_chain(const uint8_t* algorithm_ids, int chain_length,
...
void tm_ssse3_r128_map_8::test_algorithm_n(int algorithm_id, uint8_t* data, uint16_t* rng_seed, int iterations)
{
	WC_VARS_128;
	load_data(data);
	_load_from_mem(WC_PASS_128);
...
void tm_ssse3_r128_map_8::test_expansion(uint32_t data, uint8_t* result_out)
{
	WC_VARS_128;
	_expand_code(data, WC_PASS_128);
	_store_to_mem(WC_PASS_128);
...
void tm_ssse3_r128_map_8::test_bruteforce_data(uint32_t data, uint8_t* result_out)
{
	WC_VARS_128;
	_expand_code(data, WC_PASS_128);
	_run_all_maps(WC_PASS_128);
...
bool tm_ssse3_r128_map_8::test_bruteforce_checksum(uint32_t data, int world)
{
	WC_VARS_128;
	_expand_code(data, WC_PASS_128);
	_run_all_maps(WC_PASS_128);
...
void tm_ssse3_r128_map_8::set_key(uint32_t new_key)
{
