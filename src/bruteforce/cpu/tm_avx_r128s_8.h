...
// Like tm_avx_r128_8 but uses shuffled RNG tables (expansion_values_128_8_shuffled,
// alg0_values_128_8_shuffled, regular_rng_values_128_8_shuffled, alg4_values_128_8_shuffled,
// alg6_values_128_8_shuffled).  The shuffled layout pairs even/odd bytes into separate
// registers: even bytes → wc0/wc2/wc4/wc6, odd bytes → wc1/wc3/wc5/wc7.
// Carry seeds: alg2_values_128_8, alg5_values_128_8 (full 16-byte vector per seed).
