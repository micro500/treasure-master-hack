#ifndef TM_AVX2_M256_MAP_8_H
#define TM_AVX2_M256_MAP_8_H
#include <optional>
#include "simd.h"
...
class tm_avx2_m256_map_8 : public TM_base
{
public:
	tm_avx2_m256_map_8(RNG* rng);
	tm_avx2_m256_map_8(RNG* rng, uint32_t key);
	tm_avx2_m256_map_8(RNG* rng, const uint32_t key, const key_schedule& schedule_entries);
...
private:
	...
	AlignedPtr<uint8_t> expansion_values_for_seed_256_8;
