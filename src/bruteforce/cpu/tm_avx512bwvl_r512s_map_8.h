#ifndef TM_AVX512BWVL_R512S_MAP_8_H
#define TM_AVX512BWVL_R512S_MAP_8_H
#include <optional>
#include "simd.h"
...
class tm_avx512bwvl_r512s_map_8 : public TM_base
{
public:
	tm_avx512bwvl_r512s_map_8(RNG* rng);
	tm_avx512bwvl_r512s_map_8(RNG* rng, uint32_t key);
	tm_avx512bwvl_r512s_map_8(RNG* rng, const uint32_t key, const key_schedule& schedule_entries);
...
private:
	...
	AlignedPtr<uint8_t> regular_rng_values_for_seeds_512_8_shuffled;
	AlignedPtr<uint8_t> alg0_values_for_seeds_512_8_shuffled;
	AlignedPtr<uint8_t> alg6_values_for_seeds_512_8_shuffled;
...
#endif // TM_AVX512BWVL_R512S_MAP_8_H
