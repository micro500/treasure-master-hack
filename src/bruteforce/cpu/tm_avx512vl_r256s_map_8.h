...
private:
	...
	uint8_t* expansion_values_for_seed_256_shuffled_8;
	uint8_t* regular_rng_values_for_seeds_256_shuffled_8;
	uint8_t* alg0_values_for_seeds_256_shuffled_8;
	uint8_t* alg6_values_for_seeds_256_shuffled_8;
