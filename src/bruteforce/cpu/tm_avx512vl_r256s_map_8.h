#ifndef TM_AVX512VL_R256S_MAP_8_H
#define TM_AVX512VL_R256S_MAP_8_H
#include <optional>
#include "simd.h"
...
class tm_avx512vl_r256s_map_8 : public TM_base
{
public:
	tm_avx512vl_r256s_map_8(RNG* rng);
	tm_avx512vl_r256s_map_8(RNG* rng, uint32_t key);
	tm_avx512vl_r256s_map_8(RNG* rng, const uint32_t key, const key_schedule& schedule_entries);
...
private:
	...
	void alg_2_sub(__m256i& working_a, __m256i& working_b, __m256i& carry);
	void alg_5_sub(__m256i& working_a, __m256i& working_b, __m256i& carry);

	void _load_fwd(const uint8_t* block_start, __m256i& r0, __m256i& r1, __m256i& r2, __m256i& r3);
	...
	AlignedPtr<uint8_t> expansion_values_for_seed_256_shuffled_8;
	AlignedPtr<uint8_t> regular_rng_values_for_seeds_256_shuffled_8;
	AlignedPtr<uint8_t> alg0_values_for_seeds_256_shuffled_8;
	AlignedPtr<uint8_t> alg6_values_for_seeds_256_shuffled_8;
...
#endif // TM_AVX512VL_R256S_MAP_8_H
