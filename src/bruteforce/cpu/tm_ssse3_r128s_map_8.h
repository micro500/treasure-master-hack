#ifndef TM_SSSE3_R128S_MAP_8_H
#define TM_SSSE3_R128S_MAP_8_H
#include <optional>
#include "simd.h"
...
// Like tm_ssse3_r128s_8 but the hot path uses per-schedule precomputed RNG tables
...
class tm_ssse3_r128s_map_8 : public TM_base
{
public:
	tm_ssse3_r128s_map_8(RNG* rng);
	tm_ssse3_r128s_map_8(RNG* rng, uint32_t key);
	tm_ssse3_r128s_map_8(RNG* rng, const uint32_t key, const key_schedule& schedule_entries);
