#ifndef TM_AVX2_R256S_MAP_8_H
#define TM_AVX2_R256S_MAP_8_H
#include <optional>
#include "simd.h"
...
class tm_avx2_r256s_map_8 : public TM_base
{
public:
	tm_avx2_r256s_map_8(RNG* rng);
	tm_avx2_r256s_map_8(RNG* rng, uint32_t key);
	tm_avx2_r256s_map_8(RNG* rng, const uint32_t key, const key_schedule& schedule_entries);
