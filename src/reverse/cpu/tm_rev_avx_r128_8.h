...
class tm_rev_avx_r128_8 : public TM_rev_base
{
public:
	tm_rev_avx_r128_8(RNG* rng);
	...
	void alg_2_sub(__m128i& working_code, __m128i& carry);
	...
	void alg_5_sub(__m128i& working_code, __m128i& carry);
